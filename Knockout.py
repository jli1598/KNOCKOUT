...
akumawalk = Animation("akuma//akuma_walk ",14,game)
...
akumapunch = Animation("akuma//akuma_punch ",8,game)
akumapunchedinface = Animation("akuma//akuma_punchedintheface ",3,game)
akumaroundkick = Animation("akuma//akuma_regkick ",5,game)
akumaroundhousekick = Animation("akuma//akuma_roundhousekick ",15,game)
